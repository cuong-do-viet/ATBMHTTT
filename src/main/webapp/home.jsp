...
<div class="content-container">
                    ...
                    <div class="product-item">
                        <a href="<%=p.getUrlToDetail()%>">
                            ...
                            <div class="img-container flex-roww" style="justify-content: center;">
                                <img class="img-product" src="./assets/img/thumbnail/<%=p.getThumbnail()%>"
                                     alt="<%=p.getFullName()%>">
                            </div>
                            ...
                            <div class="price">
                                ...
                                <div class="flex-roww" style="justify-content: space-between;">
                                    ...
                                    <div class="info rate">
                                        <p><i class="bi bi-star-fill"></i><span
                                                class="rate-figure"><%=p.getRate()%></span>(<span
                                                class="total-estimate"><%=p.getTotalComment()%></span>)</p>
                                    </div>
                                </div>
                            </div>
                        </a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"
         style="border-radius: 10px; overflow: hidden;margin-top: 20px;">
